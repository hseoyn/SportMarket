...
<head>
    ...
    <title>Shop - Lanes Bootstrap 4 Portfolio Template</title>
...
<body>
    ...
    <div class="hamburger-area">
        ...
        <ul class="menu-primary-menu-1 responsive-manu d-block d-xl-none" id="responsive-manu">
            ...
            <li class="has-dropdown"><a href="shop.html">Shopx</a>
                <ul class="sub-menu">
                        ...
                        <div class="archive-shop-actions mb--30">
                            <div class="row align-items-center">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="btn-group ml-4 mt-4" role="group" aria-label="Basic example">
                                        <c:forEach items="${requestScope.brands}" var="brand">
                                            <a href="${path}/list?<c:if test="${param.typeId != null}">typeId=${param.typeId}&</c:if>brandId=${brand.brand_id}" class="btn btn-outline-secondary<c:if test="${brand.brand_id == param.brandId}">active</c:if>">${brand.brand_name}</a>
                                        </c:forEach>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <!-- Start Single Product -->
                                    <c:forEach items="${requestScope.commodities}" var="commodity">
                                        ...
                                        <div class="product">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="${path}/commodity">
<%--                                                        <img src="${path}/assets/images/product/product-01.jpg" alt="Product Images">--%>
                                                       <a href="${path}/commodity?commodityId=${commodity.commodity_id}&brandId=${commodity.brand_id}"><img src="${path}/${commodity.image_url}" alt="Product Images"></a>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="content">
                                                <h2><a href="${path}/commodity?commodityId=${commodity.commodity_id}&brandId=${commodity.brand_id}">${commodity.commodity_name}</a></h2>
                                                <span class="prize"><fmt:formatNumber value="${commodity.price}" type="CURRENCY"></fmt:formatNumber> </span>
                                            </div>
                                        </div>
                                        </div>
                                    </c:forEach>
                                ...
                                <div class="col-lg-12">
                                    <ul class="pagination_style">
                                        <c:forEach begin="1" end="${requestScope.pages}" varStatus="status">
                                            <li><a class="<c:if test="${requestScope.pageNum == status.count}">active</c:if>" href="${path}/list?<c:if test="${param.typeId != null}">typeId=${param.typeId}&</c:if><c:if test="${param.brandId != null}">brandId=${param.brandId}&</c:if><c:if test="${param.name != null}">name=${param.name}&</c:if>page=${status.count}">${status.count}</a></li>
                                        </c:forEach>
                        ...
                        <div class="shop-sidebar-container">
                            <div class="shop-sidebar-wrapper">
                                ...
                                <div class="shop-sidebar search">
                                    ...
                                    <form class="inner" method="get" action="${path}/list">
                                        <div class="search-box">
                                            <input type="text" name="name" value="${param.name}" placeholder="请输入关键字">
                                    ...
                                    <ul class="related-product">
                                            ...
                                            <div class="product-item">
                                                <div class="thumbnail">
                                                    <a href="single-product.html">
                                                        <img src="${path}/assets/images/product/sm-product-01.jpg" alt="multi-purpose">
                                                    </a>
                                                </div>
                                                <div class="info">
                                                    <h5 class="heading heading-h5"><a href="single-product.html">Open Front Cardigan</a></h5>
                                                    <ul class="rating">
                                        ...
                                        <li>
                                            <div class="product-item">
                                                <div class="thumbnail">
                                                    <a href="single-product.html">
                                                        <img src="${path}/assets/images/product/sm-product-02.jpg" alt="multi-purpose">
                                                    </a>
                                                </div>
                                                <div class="info">
                                                    <h5 class="heading heading-h5"><a href="single-product.html">Sample Bundle Product</a></h5>
                                        ...
                                        <li>
                                            <div class="product-item">
                                                <div class="thumbnail">
                                                    <a href="single-product.html">
                                                        <img src="${path}/assets/images/product/sm-product-03.jpg" alt="multi-purpose">
                                                    </a>
                                                </div>
                                                <div class="info">
                                                    <h5 class="heading heading-h5"><a href="single-product.html">Three-Piece Check</a></h5>
                                                    <div class="price"><span>$89.00</span> <span
                                                            class="new-price">$58.00</span></div>
                                                </div>
                                            </div>
                                ...
                                <div class="shop-sidebar nwinstagram mt--50">
                                    ...
                                    <div class="instagram-grid-wrap instagram-grid-5 inner">
                                        ...
                                        <div class="item-grid grid-style--1">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="${path}/assets/images/product/sm-product-01.jpg" alt="instagram images">
                                                </a>
                                                <div class="item-info">
                                                    <div class="inner">
                                        ...
                                        <div class="item-grid grid-style--1">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="${path}/assets/images/product/sm-product-02.jpg" alt="instagram images">
                                                </a>
                                                <div class="item-info">
                                                    <div class="inner">
                                        ...
                                        <div class="item-grid grid-style--1">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="${path}/assets/images/product/sm-product-03.jpg" alt="instagram images">
                                                </a>
                                                <div class="item-info">
                                                    <div class="inner">
                                                        <a href="#"><i class="fa fa-heart-o"></i>1k</a>
                                        ...
                                        <div class="item-grid grid-style--1">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="${path}/assets/images/product/sm-product-04.jpg" alt="instagram images">
                                                </a>
                                                <div class="item-info">
                                                    <div class="inner">
                                                        <a href="#"><i class="fa fa-heart-o"></i>1k</a>
                                        ...
                                        <div class="item-grid grid-style--1">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="${path}/assets/images/product/sm-product-05.jpg" alt="instagram images">
                                                </a>
                                                <div class="item-info">
                                                    <div class="inner">
                                                        <a href="#"><i class="fa fa-heart-o"></i>1k</a>
