...
<head>
    ...
    <title>My Account - Lanes Bootstrap 4 Portfolio Template</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner text-center">
                        <h2 class="font--40 mb--0">Address Option</h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="checkout-wrapper">
                            <div id="faq" class="panel-group">
                                <div class="panel panel-default">
                                    ...
                                    <form action="${path}/updateAddress" id="update-form" method="get">
                                        <div id="my-account-1" class="panel-collapse collapse show">
                                            <div class="panel-body">
                                                <div class="billing-information-wrapper">
                                                    ...
                                                    <div class="row">
                                                            <input type="hidden" name="addressId" value="${requestScope.address.address_id}">
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="billing-info">
                                                                <label>收件人</label>
                                                                <input type="text" name="name" value="${requestScope.address.addressee}">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="billing-info">
                                                                <label>电话号码</label>
                                                                <input type="text" name="tel" value="${requestScope.address.tel}">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="billing-info">
                                                    ...
                                                    <div class="billing-back-btn">
                                                        <div class="billing-btn">
                                                            <button id="sub-2" type="submit">确认</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
